...
public class EmployeeClass {
	...
	public void employeeDashboard(String usr,String usrTyp) throws ClassNotFoundException, IOException {
	...
	public void displayDetails() throws ClassNotFoundException, IOException {
		System.out.println("______Employee Details_____");
	...
	public void approvalList() throws ClassNotFoundException, IOException {
		...
		for(int i=0;i<fullist.size();i++) {
			...
			if(iValue.contains("approval1=No") && iValue.contains("userType=CUSTOMER")) {
	...
	public void approveAccount() throws ClassNotFoundException, IOException {
		...
		String Temp_approval1=uName;
		String Temp_approval2="No";
